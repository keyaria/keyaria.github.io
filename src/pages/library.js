...
import background1 from "../images/TC.png"
...
function LibraryPage() {
  return (
    ...
    <Header/>
      ...
      <MainContainer>
        <SideContainer>
          <SideBySide>
            ...
            <p  className="w-3/4 semibold leading-loose font-medium text-lg">
              UofM&#39;s library system still has a more traditional way of user interaction so the team
              I was involved in, was in charche of bringing quick innovitave changes that could help
              the library improve.
            </p>
          </SideBySide>
          <SideBySide className="border-l border-solid border-gray-200 p-4">
            <H3 className="flex-1 ">My Role</H3>
              <p>In a agile team of student developers I worked on different projects
              including a accessbility checklist, data anyalitics software, and a interactive
              book user and rating system.
              </p>
        ...
        <SideContainer>
          ...
          <SideBySide>
              <H3>How can we use technology to benifit the library and increase student interactions? </H3>
              <p>Many student&#39;s use the library system to study and get books for class. However, many library
              interactions could be improved wth technology and also allow student&#39;s to be more involved and participate
              in library events.
              </p>
          </SideBySide>
    ...
    <a href="/currentProject"><Card href="/currentProject" style={{backgroundImage: `url(${background1})`,  backgroundPosition: 'center',
  backgroundSize: 'cover',
  backgroundRepeat: 'no-repeat'}}></Card></a>
  <a href="/other"><Card href="/other" style={{backgroundImage: `url(${background2})`,  backgroundPosition: 'center',
  backgroundSize: 'cover',
  backgroundRepeat: 'no-repeat'}}></Card></a>
