...
const GenvidPage = () => {
    ...
    return (
        <App >
            ...
            <Heading as='h2' textAlign='left' mb='50px' fontSize='9vw' fontWeight='500' textTransform='uppercase' w='90%' lineHeight='8rem'>Genvid <Box textAlign='right'>Entertainment</Box></Heading>
            <HStack w={`calc('100%' + calc(clamp('2.5rem', '8vw', '8em') / 1.5))`} py={`calc(clamp('2.5rem', '8vw', '8em') / 2 )`}>
              {speciliaties.map((i => {
                ...
                <Image src={genvid} w='100%' h="35%" mt='2rem' backgroundSize='contain' borderRadius={'2%'}/>
            ...
            <Grid w='100%' gap={'32px'} gridAutoRows={'min-content'} gridTemplateColumns={{base: 'none', md:`repeat(8, minmax(1px, 1fr))`}} gridTemplateRows={`repeat(1, min-content)`} px='5rem' py='5rem'>
                ...
                <VStack w='100%'  gridColumn={'auto / span 4'} alignItems={'left'}>
                    <Heading as='h5'gap={'32px'}>Front End Development at Genvid</Heading>
            ...
            <Grid w='100%' gap={'32px'} gridAutoRows={'min-content'} gridTemplateColumns={{base: 'none', md:`repeat(8, minmax(1px, 1fr))`}} gridTemplateRows={`repeat(1, min-content)`} px='5rem' py='5rem'>
                ...
                <VStack w='100%'  gridColumn={'auto / span 4'} alignItems={'left'}>
                    <Heading as='h5' gap={'32px'}>Cross Platform Login and Payment</Heading>
            ...
            <Grid w='100%' gap={'32px'} gridAutoRows={'min-content'} gridTemplateColumns={{base: 'none', md:`repeat(8, minmax(1px, 1fr))`}} gridTemplateRows={`repeat(1, min-content)`} px='5rem' py='5rem'>
                ...
                <HStack w='100%'  gridColumn={'auto / span 4'} alignItems={'left'}>
                    <Image src={reactImg} w='50px' h='50px'/>

                    <Image src={tsImg} w='50px' h='50px'/>
                    <Image src={awsImg} w='50px' h='50px'/>
